...
import { GoBackToMenu, PrivacyPolicyContainer } from "./privacy-policy.style"
		...
		<PrivacyPolicyContainer>
			...
			<ul>
				...
				<li>
					<p>
						...
						'Us' or 'Our' in this Agreement) refers to Alfred Technologies, 130
						w 25th street.
					</p>
				</li>
				<li>
				...
				<li>
					<p>
						<strong>Website</strong> refers to get alfred, accessible from{" "}
						<a
							href='https://www.getalfred.com/'
							rel='external nofollow noopener noreferrer'
							target='_blank'
						>
							https://www.getalfred.com/
						</a>
					</p>
				</li>
				<li>
			...
			<ul>
				<li>
					...
					<a
						href='https://www.getalfred.com/contact-us'
						rel='external nofollow noopener noreferrer'
						target='_blank'
					>
						https://www.getalfred.com/contact-us
					</a>
				</li>
			</ul>
		</PrivacyPolicyContainer>
