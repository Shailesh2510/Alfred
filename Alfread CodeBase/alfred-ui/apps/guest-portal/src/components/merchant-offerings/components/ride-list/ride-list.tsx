...
import { customNotification, validateScheduleRideTime } from "@/shared-utils"
...
import PaymentFailedModal from "@/components/order-page/components/payment-failed/payment-failed"
				...
				<Grid m={0} gutter={36}>
					...
					>
						<Flex direction='column'>
							...
							{rideOptions.length === 0 || rideOptions === null ? (
