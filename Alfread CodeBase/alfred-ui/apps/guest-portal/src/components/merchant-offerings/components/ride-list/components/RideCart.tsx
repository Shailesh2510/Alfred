...
import CartItem from "@/components/order-page/components/cart-item"
...
const RideCart = () => {
	...
	const { ride, setShowCartModal, rideOptions, setOpenChangeRideForm } =
		useRideStore()
				...
				<>
					<React.Fragment key={ride?.items?.id}>
						<CartItem
							...
							cartItemId={ride?.items?.cartItemId}
