...
export const OrderContainer: any = styled.div<{ status: string }>`
	...
	border-radius: 8px;
	${props =>
		props.status === ORDER_STATUS.INITIATED.value &&
		css`
			background-color: ${props.theme.colors.teal[0]};
		`}
	${props =>
...
export const OrderHeader: any = styled.div<{
	status: string
	...
	background-color: ${props => props.merchantColor};
`
...
export const OrderFooter: any = styled.div`
	...
	border-top: 1px solid ${({ theme }) => theme.colors.gray[4]};
`
export const HotelName: any = styled.div`
	${({ theme }) => theme.other.typography.sm600};
`

export const HotelAddress: any = styled.div`
	font-size: 13px;
...
export const MerchantAddress: any = styled.div`
	font-size: 13px;
	${({ theme }) => theme.other.typography.xs400};
`

export const GuestName: any = styled.div`
	${({ theme }) => theme.other.typography.sm600};
`

export const RoomNumber: any = styled.div`
	font-size: 13px;
	${({ theme }) => theme.other.typography.xs400};
`
