...
export const cartActionTypes = {
	...
	SET_SHOW_VOUCHER_NOT_FOUND_POPUP: "SET_SHOW_VOUCHER_NOT_FOUND_POPUP",
	SET_SHIPDAY_DELIVERY_FEE: "SET_SHIPDAY_DELIVERY_FEE",
	SET_SELECTED_MERCHANT_ID: "SET_SELECTED_MERCHANT_ID",
	SET_SHOW_SCHEDULE_MODAL_OPEN: "SET_SHOW_SCHEDULE_MODAL_OPEN"
}
...
const cartReducer = (state: any, action: any) => {
	switch (action.type) {
		...
		case cartActionTypes.SET_SHOW_VOUCHER_NOT_FOUND_POPUP:
			return {
				...state,
				showVoucherNotFoundPopup: action.showVoucherNotFoundPopup
			}
		case cartActionTypes.SET_SHIPDAY_DELIVERY_FEE:
			return { ...state, shipdayDeliveryFee: action.shipdayDeliveryFee }
		case cartActionTypes.SET_SELECTED_MERCHANT_ID:
			return {
				...state,
				selectedMerchantId: action.selectedMerchantId
			}
		case cartActionTypes.SET_SHOW_SCHEDULE_MODAL_OPEN:
			return {
				...state,
				showScheduleModal: action.showScheduleModal
			}
